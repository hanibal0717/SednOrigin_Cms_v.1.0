					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="purchs.title" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="search">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<c:forEach var="result" items="${resultList}" varStatus="status">
								<tr>
									...
									<td align="center" class="listtd"><spring:message
											code="${result.dlvySe}" /></td>
								</tr>
							</c:forEach>
						</table>
					</div>
