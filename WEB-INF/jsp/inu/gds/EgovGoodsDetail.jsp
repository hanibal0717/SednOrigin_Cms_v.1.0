...
<validator:javascript formName="goodsVO" staticJavascript="false"
			...
			<div id="content_pop">
				<form:form commandName="goodsVO" name="detailForm">
					...
					<input type="hidden" name="selectedId"
						value="<c:out value='${goodsVO.goodsId}'/>" />
					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="goods.title" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="table">
						<table border='0' width='100%' summary="품목의 상세 정보를 확인합니다.">
							...
							<tr>
								<td colspan='2'><c:out
										value="${goodsVO.categoryVO.ctgryNm}" /></td>
							</tr>
							<tr>
								<td colspan='2'>
							...
							<tr>
								<td rowspan='2'><img
									src="<c:url value='/GoodsImage/${goodsVO.goodsImageVO.goodsImageId}'/>"
									style="margin-left: 6px; margin-right: 40px;" height="200"
									width="200" alt="Item Image" /></td>
								<td>
									<table width="100%" border="1" cellpadding="0" cellspacing="0"
										...
										<tr>
											<td class="tbtd_caption"><spring:message
													code="goods.price" /></td>
											<td class="tbtd_content"><spring:eval
													expression='new java.text.DecimalFormat("###,##0").format(goodsVO.price)' />
												<spring:message code="cart.won" /> &nbsp;<form:errors
													path="price" /></td>
										</tr>
										<tr>
											<td class="tbtd_caption"><spring:message
													code="goods.makr" /></td>
											<td class="tbtd_content"><c:out value="${goodsVO.makr}" />
										...
										<c:if test="${goodsVO.useAt == '1'}">
											<tr>
												<td class="tbtd_caption"><spring:message
														code="goods.qy" /></td>
												<td class="tbtd_content"><input type="text" name="qy"
													value="0" maxlength="3"
													onkeyup="javascript:requestSum('${goodsVO.price}')"
													onchange="javascript:requestSum('${goodsVO.price}')"
													title="<spring:message code="goods.qy"/>" /></td>
											</tr>
											<tr>
												<td class="tbtd_caption"><spring:message
														code="goods.sum" /></td>
										...
										<ul>
											<c:if test="${goodsVO.useAt == '1' && loginVO != null}">
												<li><span class="btn_blue_l"
													title="<spring:message code="goods.btn.insertCart"/>"><a
														href="#link" onclick="fn_egov_insertCart(); return false;"><spring:message
																code="goods.btn.insertCart" /></a><img
														src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
														style="margin-left: 6px;"
														alt="<spring:message code="goods.btn.insertCart"/>" /></span></li>
												<li><span class="btn_blue_l"
													title="<spring:message code="goods.btn.buyNow"/>"><a
														href="#link"
														onclick="fn_egov_insertPurchase(); return false;"><spring:message
																code="goods.btn.buyNow" /></a><img
														src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
														style="margin-left: 6px;"
														alt="<spring:message code="goods.btn.buyNow"/>" /></span></li>
											</c:if>
											<c:if test="${goodsVO.useAt == '0'}">
												<li><spring:message code="goods.deleteGoods" /></li>
											</c:if>
											<li><span class="btn_blue_l"
												title="<spring:message code="goods.btn.list"/>"><a
													href="#link" onclick="fn_egov_selectList(); return false;"><spring:message
															code="goods.btn.list" /></a><img
													src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
													style="margin-left: 6px;"
													alt="<spring:message code="goods.btn.list"/>" /></span></li>
										</ul>
									</div>
								</td>
							</tr>
						...
						<table border="0" width="100%" summary="품목의 상세 이미지를 확인 할 수 있습니다.">
							...
							<tr>
								<th style="text-align: left" colspan='2' height="40">&nbsp;&nbsp;&nbsp;<spring:message
										code="goods.detail" /></th>
							</tr>
							<tr>
								<td colspan='2' class="tbtd_content"><img
									src="<c:url value='/GoodsImage/${goodsVO.detailImageVO.goodsImageId}'/>"
									width='100%' alt="<spring:message code="goods.detail"/>" /></td>
							</tr>
						</table>
					</div>

					<c:if
						test="${loginVO.mngrSe == 'ROLE_ADMIN' && goodsVO.useAt == '1'}">
						<div class="sysbtn" style="margin-top: 10px">
							<ul>
								<li><span class="btn_blue_l"
									title="<spring:message code="goods.btn.update"/>"><a
										href="#link" onclick="fn_egov_update(); return false;"><spring:message
												code="goods.btn.update" /></a><img
										src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
										style="margin-left: 6px;"
										alt="<spring:message code="goods.btn.update"/>" /></span></li>
								<li><span class="btn_blue_l"
									title="<spring:message code="goods.btn.delete"/>"><a
										href="#link" onclick="fn_egov_delete(); return false;"><spring:message
												code="goods.btn.delete" /></a><img
										src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
										style="margin-left: 6px;"
										alt="<spring:message code="goods.btn.delete"/>" /></span></li>
