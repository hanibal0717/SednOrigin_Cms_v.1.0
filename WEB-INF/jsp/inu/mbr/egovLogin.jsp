...
<title>egov | <spring:message code="mbr.login" />
</title>
...
function fn_egov_login() {
	mberId = document.detailForm.id.value;
	password = document.detailForm.pwd.value;
	
	if(mberId == "" && password == ""){
		alert("<spring:message code="mbr.blankBoth" />");
		return;
	}else if(mberId != "" && password == ""){
		document.detailForm.pwd.focus();
					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="mbr.login" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="table">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							summary="아이디와 비밀번호를 입력하여 로그인 합니다.">
							<caption>로그인</caption>
							<colgroup>
								<col width="150">
								<col width="">
							...
							<tr>
								...
								<td class="tbtd_content"><input name="id" maxlength="20"
									style="width: 30%;"
									title="<spring:message code="mbr.header.id" />" /></td>
							</tr>
							<tr>
								<td class="tbtd_caption"><spring:message
										code="mbr.header.pass" /></td>
								<td class="tbtd_content"><input type=password name="pwd"
									maxlength="20" style="width: 30%;"
									title="<spring:message code="mbr.header.pass" />" /></td>
							</tr>
						</table>
					</div>
					<div id="sysbtn">
						<ul>
							<li><span class="btn_blue_l"
								title="<spring:message code="mbr.login" />"><a
									href="#link" onclick="fn_egov_login(); return false;"><spring:message
											code="mbr.login" /></a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="mbr.login" />" /></span></li>
							<li><span class="btn_blue_l"
								title="<spring:message code="mbr.searchPass" />"><a
									href="#link" onclick="fn_egov_searchPass(); return false;"><spring:message
											code="mbr.searchPass" /></a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="mbr.searchPass" />" /></span></li>
