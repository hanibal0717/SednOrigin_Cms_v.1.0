					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="mbr.searchPass" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="table">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							summary="회원의 아이디와 이메일주소를 입력하여 비밀번호를 확인합니다.">
							...
							<tr>
								<td class="tbtd_content" colspan=2>* <spring:message
										code="msg.searchEmail" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="tbtd_content"><input name="email" maxlength="50"
									style="width: 70%;" /></td>
							</tr>
						</table>
					</div>
