            ...
            success:function(data){
				...
				if(pNo){
					myTree.appendTree(obj.index, obj.item, [{ type:"file", 'no': no , pno : $('#pno').val(), menuName:$('#menuName').val() 
						, menuPath:$('#menuPath').val() , menuTxt:$('#menuTxt').val() , useYn:$('#useYn').val() }]);	
				} else {
					myTree.updateTree(obj.index, obj.item, { menuName:$('#menuName').val(), menuPath:$('#menuPath').val() , menuTxt:$('#menuTxt').val() , useYn:$('#useYn').val() });
				} 
				myTree.clearFocus();
				clearForm();
				$('#upMenu').text('');
...
<h4 class="page-title">관리자 메뉴 관리</h4>

<div class="block-area">
	<form name="frm" id="frm" method="post" >
	<input type="hidden" name="status" id="status" value="" />
	<div class="row m-t-15">
		<label class="pull-left m-l-10">시스템 구분</label>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="table-responsive overflow" style="overflow: hidden; outline: none;">
				<table class="table table-bordered tile">
					...
					<tr>
						...
						<td>
							<div class="col-md-12">
								<input type="text" name="no" id="no" pno="" class="form-control input-sm" readOnly/> 
					...
					<tr>
						...
						<td>
							<div class="col-md-12">
								<input type="text" name="menuName" id="menuName"  class="form-control input-sm" maxlength="50" onkeyup="inputLengthCheck(this);" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="col-md-12">
								<input type="text" name="menuPath" id="menuPath"  class="form-control input-sm" maxlength="100" onkeyup="inputLengthCheck(this);" />
							</div>
						</td>
					</tr>
			<!-- 						<tr>
			...
			<div class="row text-right m-b-10 m-r-5">
				<button class="btn-sm btn" id="add">신규</button>
