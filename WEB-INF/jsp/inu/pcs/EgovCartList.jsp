				...
				<form:form commandName="searchVO" name="listForm" method="post">
					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="cart.title" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="search">
					...
					<div id="table">
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<thead>
								<tr>
									<th align="center"><input type="checkbox" name="allChk"
										onclick="fn_check_all();" title="checkBox" /></th>
									<th align="center"><spring:message
											code="cart.header.goodsNm" /></th>
									<th align="center"><spring:message
											code="cart.header.price" /></th>
							...
							<c:forEach var="result" items="${resultList}" varStatus="status">
								<tr>
									<td align="center" class="listtd"><input type="checkbox"
										name="cart_col_check[]" value='${result.cartId}'
										title="checkBox" /></td>
								...
								<c:set var="sum"
									value="${sum+(result.goodsVO.price * result.qy)}" />
							</c:forEach>
						</table>
					</div>
					<!-- /List -->
					<div id="sysbtn">
						<ul>
							<li><span class="btn_blue_l"
								title="<spring:message code="cart.btn.purchase"/>"><a
									href="#link" onclick="fn_egov_purchase(); return false;"><spring:message
											code="cart.btn.purchase" /></a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="cart.btn.purchase"/>" /></span></li>
							<li><span class="btn_blue_l"
								title="<spring:message code="cart.btn.delete"/>"><a
									href="#link" onclick="fn_egov_delete(); return false;"><spring:message
											code="cart.btn.delete" /></a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="cart.btn.delete"/>" /></span></li>
