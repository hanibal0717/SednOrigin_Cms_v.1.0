			...
			<div id="content_pop">
				<form:form commandName="searchVO" name="listForm" method="post">
					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="board.title" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<div id="search">
							...
							<thead>
								<tr>
									...
									<th align="center"><spring:message
											code="board.header.title" /></th>
									<th align="center"><spring:message
											code="board.header.writer" /></th>
									<th align="center"><spring:message
											code="board.header.date" /></th>
								</tr>
							</thead>
							<c:forEach var="result" items="${resultList}" varStatus="status">
								<tr>
									...
									<td align="left" class="listtd"><a href="#link"
										onClick="fn_egov_select('<c:out value="${result.no}"/>'); return false;"><c:out
												value="${result.sj}" /> </a></td>
									<td align="center" class="listtd"><c:out
											value="${result.mberId}" />&nbsp;</td>
									<td align="center" class="listtd"><c:out
					...
					<div id="sysbtn">
						<ul>
							<li><span class="btn_blue_l"
								title="<spring:message code="button.add" />"><a
									href="#link" onClick="fn_egov_addView(); return false;"><spring:message
											code="button.add" /> </a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="button.add" />" /> </span></li>
