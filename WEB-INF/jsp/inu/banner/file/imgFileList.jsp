...
%>
	...
	<img src='/vod/file/getImage.do?file_gubun=<%=fileGubun %>&data_idx=<%=dataIdx %>&attach_idx=<%=attachIdx %>'  alt="해당파일이미지" name="displayImg<%=imgIndex+i %>" onload="javascript:setImgFit(this, 350, '<%=imgIndex+i%>');" />
	</p>
<%		
		}
	}
