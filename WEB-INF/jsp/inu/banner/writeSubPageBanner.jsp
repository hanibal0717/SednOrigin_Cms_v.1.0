...
<%
			/**
			* @JSP Name : wrtieSubPageBanner.jsp
...
<p class="location"> 배너관리 > SlidingBanner</p>
		...
		<p class="tar Mbo11">
			...
			<table class="data_tableW02">
				...
				<tr>
					<th>공지</th>
					<td>
						<input type="checkbox" name="notice_yn" id="notice_yn" maxlength="50" class="textInput_size01" value="Y"  ${bbsDataInfo.noticeYn eq 'Y' ? 'checked="checked"':''} />
					</td>
				</tr> -->
				<tr>
					<th>내용</th>
