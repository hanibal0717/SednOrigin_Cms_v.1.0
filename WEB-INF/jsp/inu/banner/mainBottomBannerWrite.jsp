...
<%
			/**
			* @JSP Name : mainBottomBannerWrite.jsp
			* @Description : 메인 하단 배너 등록/수정
...
if( bbsDataInfo == null ){
	modeType = "ins";
	actPage = "/banner/insertMainBottomBanner.do";
	msg = "등록";
} else {
	
	if( !"reply".equals(modeType) && !"replyM".equals(modeType) ){ 
		modeType = "mod";
		actPage = "/banner/modifyMainBottomBanner.do";
		msg = "수정";
	}
...
function save(){
	...
	var f = document.frm; 
	f.action = "/banner/insertMainBottomBanner.do";
	f.submit();
}
function remove(){
	if( $('#bnIdx').val() == '' ){
...
<form name="frm" id="frm" method="post" enctype="multipart/form-data" >
	...
	<input type="hidden" id="bnGubun" name="bnGubun" value="03" />
	...
	<div class="table-responsive overflow" style="overflow: hidden; outline: none;">
		<table class="table table-bordered tile">
			...
			<tr>
				<th scope="col">배너 이미지&nbsp;&nbsp;&nbsp;size : 320*197</th> 
				<td colspan="3">
					<div class="col-md-12">
