...
<body>
<h2><%=bbsNm %></h2>
<p class="location"> 게시판관리 > 등록</p>

<form name="bbs_data_frm" id="bbs_data_frm" method="post" enctype="multipart/form-data" >
	...
	<section> 
		<p class="tar Mbo11">
			...
			<table class="data_tableW02">
				...
				<tr>
					<th><span class="tx_red02">*</span>&nbsp;작성자</th>
					<td>
						<input type="text" name="reg_nm" id="reg_nm" maxlength="100" class="textInput_size01" value="<%=regNm %>" />
					</td>
				</tr>
				<% if( "Y".equals(mstNoticeYn)){ %> 
				<tr>
					<th>공지</th>
					<td>
						<input type="checkbox" name="notice_yn" id="notice_yn" maxlength="50" value="Y"  ${bbsDataInfo.noticeYn eq 'Y' ? 'checked="checked"':''} />
					</td>
				</tr>  
				<% } %>
				<tr>
...
if( "ins".equals(modeType) || ( bbsDataFile == null || bbsDataFile.size() == 0) ) {%>	
				<script type="text/javaScript">
					var maxFileNum = document.bbs_data_frm.posblAtchFileNumber.value;
					
					if(maxFileNum == null || maxFileNum == ""){ maxFileNum = document.bbs_data_frm.fileListCnt.value; }
...
<% 
			...
			<script type="text/javascript">
				var existFileNum	= document.bbs_data_frm.fileListCnt.value;
				var maxFileNum		= document.bbs_data_frm.posblAtchFileNumber.value;
