				...
				<form:form name="listForm" method="GET">
					...
					<div id="title2">
						<ul>
							<li><img
								...
								alt="" /> <spring:message code="category.title" /></li>
						</ul>
					</div>
					<!-- // 타이틀 -->
					<!-- List -->
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<c:forEach var="category" items="${categoryList}"
								...
								<tr>
									...
									<td align="center" class="listtd"><spring:url
											value="/springrest/cgr/{id}.html" var="categoryUrl"
											htmlEscape="true">
											<spring:param name="id" value="${category.ctgryId}" />
										</spring:url> <a class="linkClass" href="${categoryUrl}"><c:out
												value="${category.ctgryId}" /></a></td>
									<td align="left" class="listtd"><c:out
											value="${category.ctgryNm}" /></td>
									<td align="center" class="listtd"><c:out
											value="${category.dc}" /></td>
								</tr>
							</c:forEach>
						</table>
					</div>
					...
					<div id="sysbtn">
						<ul>
							...
							<spring:url value="/springrest/cgr.json" var="jsonUrl"
								htmlEscape="true" />
							<li><span class="btn_blue_l"
								title="<spring:message code="button.json" />"><a
									href="${jsonUrl}"><spring:message code="button.json" /></a><img
									src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>"
									style="margin-left: 6px;"
									alt="<spring:message code="button.json" />" /></span></li>
